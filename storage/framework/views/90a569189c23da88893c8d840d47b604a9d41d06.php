          ...
          <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="address_one" name="address_one" value="Setra Dute Cemara">
                </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
...
<?php $__env->startPush('addon-script'); ?>
    ...
    <script>
      ...
      <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bwastore-laravel\resources\views/pages/cart.blade.php ENDPATH**/ ?>