                      ...
                      <div class="card">
                        <div class="card-body">
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="form-group">
                                <label for="addressTwo">Your E-mail</label>
                                <input
                                  type="email"
                                  class="form-control"
                                  id="email"
...
<?php $__env->startPush('addon-script'); ?>
    ...
    <script>
      ...
      <?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bwastore-laravel\resources\views/pages/dashboard-account.blade.php ENDPATH**/ ?>