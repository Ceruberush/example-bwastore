	...
	<div class="container-fluid">
		<div class="dashboard-heading">
				...
				<p class="dashboard-subtitle">
						Edit "<?php echo e($item->name); ?>" Product
				</p>
		</div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <select name="users_id" class="form-control">
												<option value="<?php echo e($item->userd_id); ?>" selected><?php echo e($item->user->name); ?></option>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bwastore-laravel\resources\views/pages/admin/product/edit.blade.php ENDPATH**/ ?>